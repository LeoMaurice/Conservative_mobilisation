...
```{r}
plot(stm_lda, type = "perspectives", topics = c(1,6))
...
```{r}
plot(stm_lda, type = "perspectives", topics = c(3,6))
...
```{r}
plot(stm_lda, type = "perspectives", topics = c(2,4))
...
ggdotchart(total_coeffs|>
  ...
  theme(axis.text.x = element_text(angle = 45, hjust = 1, vjust = 1))+
  title(main = "Effets de l'idéologie sur la prévalence des topics")
```
